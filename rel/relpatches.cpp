...
namespace relpatches
{
    ...
    Tickable patches[] = {
        ...
        {
            .name = "merge-heaps",
            .message = "[mod]  Merge game heaps patch %s\n",
            .main_loop_init_func = merge_heaps::init_main_loop,
        }
    };
    ...
    namespace merge_heaps {
        ...
        void init_main_loop() {
            patch::hook_function(mkb::g_create_game_heaps, create_merged_game_heaps);
            patch::hook_function(mkb::g_destroy_game_heaps, destroy_merged_game_heaps);
        }
    }
}
