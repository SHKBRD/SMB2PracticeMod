...
static patch::Tramp<decltype(&mkb::g_reset_cm_course)> s_g_reset_cm_course_tramp;
...
void init() {
    patch::hook_function(s_g_reset_cm_course_tramp, mkb::g_reset_cm_course, []() {
        s_g_reset_cm_course_tramp.dest();
